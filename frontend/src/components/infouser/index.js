                    ...
                    <div className="block block-rounded block-bordered">
		                ...
		                <div className="block-content">
							...
							<div className="row form-group">
								...
								<div className="col-md-8">
									<input name="phone" type="text" className="form-control" onKeyPress={this.onKeyPress} onChange={(e)=>{this.ChangeInfoUser(e)}} value={phone}/>
								</div>
							</div>
							<div className="row form-group">
								<div className="col-md-4"><label className="mt-2">Mật khẩu cũ:</label></div>
								<div className="col-md-8">
									<input autoComplete="new-password" name="old_pass" type="password" className="form-control" onChange={(e)=>{this.ChangeInfoUser(e)}} value={old_pass}/>
								</div>
							</div>
							...
							<div className="row form-group">
								...
								<div className="col-md-8">
									<input autoComplete="new-password" name="new_pass" type="password" className="form-control" onChange={(e)=>{this.ChangeInfoUser(e)}} value={new_pass}/>
								</div>
							</div>
							...
							<div className="row form-group">
								...
								<div className="col-md-8">
									<input autoComplete="new-password" name="re_pass" type="password" className="form-control" onChange={(e)=>{this.ChangeInfoUser(e)}} value={re_pass}/>
								</div>
							</div>
							...
							<div className="row mt-4">
								<div className="col-md-12">
									<div className="form-group float-right w-100">
										<button onClick={() => {this.props.saveDataUser(this.props.auth.edituser)}} type="button" className="btn btn-hero-primary btn-rounded btn-block">Lưu</button>
									</div>
								</div>
							</div>
						</div>
...
export default connect(mapStateToProps, { updateUserInfo, saveDataUser }) (info_user);