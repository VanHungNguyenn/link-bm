	...
	render() {
		...
		const columns = [
			...
			},
			{
				text: 'Nội dung',
				dataField: 'noidung',
				formatter:(cell, row, rowIndex) => <Fragment>{row.noidung.slice(0, 30)}</Fragment>
			},
			{
				text: 'Tiền nạp',
				dataField: 'tien_nap',
                    ...
                    <div className="block block-rounded block-bordered">
						...
						<div className="block-content">
							<div style={{"marginTop":"15px"}}>
								<ToolkitProvider keyField="_id" data={ admindespit } columns={ columns } search >
									{
										props => (
											<div>
												...
												<div className="row mb-4">
													<div className="col-md-12">
														Tháng năm: <input type="text" placeHolder="dd-yyyy" id="tongtien" name="tongtien" onChange={this.onChange} /> - Tổng tiền: <span className="text-danger" style={{"font-weight": "bold"}}>{totalmoney}</span> VNĐ
													</div>
												</div>
...
export default connect(mapStateToProps, {laylichsunapadmin, getTotalMoney})(AdminLichSuNapTien);